...
char *colorStr[] = {"yellow", "red", "green", "blue"};
...
void Init()
{
	...
	g_dingSound = new Sound("Assets/Sounds/ding.wav");
	g_buttonSound = new Sound("Assets/Sounds/button.wav");
...
void Kill()
{
	SAFE_DELETE(g_buttonSound);
	SAFE_DELETE(g_dingSound);
