...
void Object3D::Reset()
{
	...
	m_position = m_offset = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
...
void Object3D::SetOffset(D3DXVECTOR3 offset)
{
	m_offset = offset;
}
...
D3DXMATRIX Object3D::GetMatrix()
{
	...
	D3DXVec3Cross(&m_look, &m_right, &m_up);
	D3DXVec3Normalize(&m_look, &m_look);
	...
	D3DXMatrixTranslation(&trans, m_position.x + m_offset.x, m_position.y + m_offset.y, m_position.z + m_offset.z);
